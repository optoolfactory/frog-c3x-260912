...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 9999.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 9999.
    self._DISTRACTED_TIME = 9999. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 9999.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 9999.
