...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._AWARENESS_TIME = 999930. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 999915.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 99996.
    self._DISTRACTED_TIME = 999911. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 99998.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 99996.
